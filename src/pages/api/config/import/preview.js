...
import { previewImport } from "utils/config/import-assistant";
...
export default async function handler(req, res) {
  ...
  try {
    const { sourceType, inputs } = req.body ?? {};
    const result = previewImport({ sourceType, inputs: inputs ?? {}, existingRawConfigs: existingRawConfigs() });
