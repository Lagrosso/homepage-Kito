...
5. Strukturierte Bearbeitung (Formulare) mit kommentarerhaltendem YAML-Parser statt destruktivem Round-Trip.
6. Echte Authentifizierung/Session statt Token, ggf. Audit-Log.
